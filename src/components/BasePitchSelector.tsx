...
export default function BasePitchSelector({ basePitch, setBasePitch}: BasePitchProps) {
    ...
    <div className='pitch-selector'>
      <div className='ps-inner-grid'>
        ...
        <div className='ps-button'>
          <div className='button-minus' onClick={() => handleOffset(-1)}>
          </div>
        </div>
        {/*
        ...
        */}
        ...
        <div className='ps-button'>
          <div className='button-plus' onClick={() => handleOffset(1)}>
          </div>
        </div>
      </div>
    </div>
